...
export default function Home() {
  ...
  useEffect(() => {
    if (liquidityHover === undefined && protocolData) {
      setLiquidityHover(formattedTvlData[formattedTvlData.length - 1]?.value)
    }
...
<PageWrapper>
    ...
    <AutoColumn gap="16px">
    <TYPE.main>Sithswap Overview</TYPE.main>
    <ResponsiveRow>
        <ChartWrapper className="cards" data-augmented-ui="border bl-clip br-clip tl-clip tr-clip">
        <LineChart
